...
mod components;
use components::{Ball, Collider, FPSText, Goal, Paddle, Player, ScoreText, TextContainer, Wall};

mod systems;
use systems::{ball_collision, ball_movement, paddle_movement, update_text, window_resize_listener};
